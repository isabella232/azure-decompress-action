# Microsoft Azure Decompress Action
...
The [Microsoft Azure Decompress Action](docs/AzureDecompress-action.md) decompress files from a container on Azure Blob Storage Blob service into another container.
